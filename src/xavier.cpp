...
namespace xavier
{
 ...
 //    }
	...
	{
		// Cut query1 and query2 into left and right sections from seed position
		...
		int leftScore = global_alignment( queryHPrefix, queryVPrefix, scoringScheme, scoreDropOff );
		int rightScore = global_alignment( queryHSuffix, queryVSuffix, scoringScheme, scoreDropOff );
